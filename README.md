...
This project is a small personal exercise in data analysis.  It fetches daily Bitcoin data from the CoinGecko API, aggregates it to monthly frequency and displays simple charts to visualize trading volume, average price and returns. 
